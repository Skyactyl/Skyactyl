...
<head>
    ...
    <title>@yield('title') - {{ config('app.name', 'Skyactyl') }}</title>
    ...
    @section('scripts')
        ...
        {!! Theme::css('css/skyactyl.css?t={cache-version}') !!}
    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="{{ route('index') }}" class="logo">
                <span>{{ config('app.name', 'Skyactyl') }}</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            Copyright &copy; {{ date('Y') }} <a href="https://skyactyl.dev/">Skyactyl</a>.
        </footer>
    </div>
