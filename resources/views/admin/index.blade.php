...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-sm-3 text-center">
            <a href="https://skyactyl.dev/docs"><button class="btn btn-primary" style="width:100%;"><i
                        class="fa fa-fw fa-link"></i> @lang('admin/index.docs-btn')</button></a>
        </div>
        <div class="clearfix visible-xs-block">&nbsp;</div>
        <div class="col-xs-6 col-sm-3 text-center">
            <a href="https://github.com/skyactyl/panel"><button class="btn btn-primary" style="width:100%;"><i
        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <a href="https://github.com/skyactyl/panel/issues" class="btn btn-primary"><i class="fa fa-fw fa-github"></i> @lang('admin/index.feedback-btn')</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
