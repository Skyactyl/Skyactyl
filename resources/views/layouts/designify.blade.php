...
<head>
    ...
    <link rel="shortcut icon" href="/skyactyl/designify.png">
        ...
        <aside
            ...
            <div class="flex flex-col space-y-2 px-2">
                ...
                <form action="{{ route('admin.designify.reset') }}" method="POST"
                    onsubmit="return confirm('Are you sure you want to reset Skyactyl settings to default?');">
                    @csrf
                    <button type="submit"
                    ...
                    <div class="shadow-2xl overflow-hidden"
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-center space-x-2 mb-2">
                                <img src="/skyactyl/designify.png" class="h-10" alt="logo" />
