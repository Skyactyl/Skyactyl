...
const MaintenanceAlert = () => {
    const isUnderMaintenance = useStoreState((state: ApplicationStore) => state.skyactyl.data!.isUnderMaintenance);
    return (
        <>
            {isUnderMaintenance ? (
                <Container>
                    <AlertContainer className={`bg-yellow-500/10 border-yellow-500`}>
                        ...
                        <div>
                            <b>Maintenance Mode!</b> Your clients will be unable to access Skyactyl panel until you
