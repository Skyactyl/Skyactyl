        ...
        server: {
            ...
            options: process.env.USE_LOCAL_CERTS
                ? {
                      ...
                      cert: path.join(__dirname, '../../docker/certificates/skyactyl.test.pem'),
                      key: path.join(__dirname, '../../docker/certificates/skyactyl.test-key.pem'),
                  }
                : undefined,
        },
        static: {
