        ...
        <LoginFormContainer title={t('checkpoint.title')} css={tw`w-full flex`}>
            ...
            <div css={tw`mt-3 text-center`}>
                <span
                    ...
                    css={tw`cursor-pointer text-sm text-skyactyl/80 tracking-wide no-underline hover:text-skyactyl/50`}
                >
            ...
            <div css={tw`mt-3 text-center`}>
                <Link
                    to={'/auth/login'}
                    css={tw`text-sm text-skyactyl/80 tracking-wide no-underline hover:text-skyactyl/50`}
                >
                    {t('return')}
                </Link>
            </div>
