...
### Changed
* Change Skyactyl UI Components import from `@/components/` to `@/skyactyl/`
* Store user locale in database
* Update Telemetry Collection *(Skyactyl now collects anonymous telemetry data)*
...
### Changed
* Use Skyactyl Repo for Upgrade Command (`p:upgrade`)
