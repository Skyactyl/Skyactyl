...
const QuickLinks = () => {
    ...
    const statusCardLink = useStoreState((state: ApplicationStore) => state.skyactyl.data?.statusCardLink);
    const supportCardLink = useStoreState((state: ApplicationStore) => state.skyactyl.data?.supportCardLink);
    const billingCardLink = useStoreState((state: ApplicationStore) => state.skyactyl.data?.billingCardLink);
