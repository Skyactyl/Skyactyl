# Local Development
Skyactyl is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of Skyactyl will include pre-compiled, minified, and hashed assets ready-to-go.
