...
import { StatBlock } from '@/skyactyl/ui/StatBlock';
import { useTranslation } from 'react-i18next';
import Blur from '@/skyactyl/ui/Blur';
        ...
        <Link to={`/server/${server.id}`}>
            <Card className='!p-0'>
                <div
                    ...
                    style={{
                        backgroundImage: `url(${server.eggBanner ? server.eggBanner : '/skyactyl/default-bg.png'})`,
                    }}
                >
                    <div
