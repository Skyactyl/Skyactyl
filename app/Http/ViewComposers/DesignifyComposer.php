...
{
    private array $skyactylDefaults;
    ...
    public function __construct(
        ...
        $this->skyactylDefaults = [
            'customCopyright' => config('designify.customCopyright', true),
            'copyright' => config('designify.copyright') ?? 'Powered by [Skyactyl](https://skyactyl.dev/)',
            ...
            'alertMessage' => config('designify.alertMessage') ?? '**Welcome to Skyactyl!** You can modify Theme Look & Feel using [Designify](/admin/designify) at the administration area.',
            'site_color' => config('designify.site_color') ?? '#3b82f6',
            'site_title' => config('designify.site_title') ?? 'Skyactyl',
            'site_description' => config('designify.site_description') ?? 'Our official control panel made better with Skyactyl.',
            'site_image' => config('designify.site_image') ?? '/skyactyl/logo.png',
            'site_favicon' => config('designify.site_favicon') ?? '/skyactyl/icon.png',
    ...
    {
        $view->with('skyactylConfiguration', $this->skyactylDefaults);
    }
}