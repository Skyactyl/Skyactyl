...
import Md2React from '@/skyactyl/ui/Md2React';
...
const Announcement = () => {
    const alertType = useStoreState((state: ApplicationStore) => state.skyactyl.data!.alertType);
    const alertMessage = useStoreState((state: ApplicationStore) => state.skyactyl.data!.alertMessage);
    return (
        <Container>
            {alertType !== 'disabled' ? (
                <AlertContainer
               ...
               ${
                   alertType === 'info'
                       ...
                       ? 'bg-skyactyl/10 border-skyactyl'
                       : alertType === 'danger'
                ...
                >
                    <div>
                        {alertType === 'info' ? (
                            ...
                            <BellIcon className='h-5 w-5 font-bold !text-skyactyl' />
                        ) : alertType === 'danger' ? (
