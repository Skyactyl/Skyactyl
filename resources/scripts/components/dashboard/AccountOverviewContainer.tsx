...
import ContentBlock from '@/skyactyl/ui/ContentBlock';
import Card from '@/skyactyl/ui/Card';
import Gravatar from '@/skyactyl/ui/Avatar';
import { useStoreState } from 'easy-peasy';
import { ApplicationStore } from '@/state';
import TitledGreyBox from '../elements/TitledGreyBox';
import Title from '@/skyactyl/ui/Title';
import { ExternalLinkIcon, LogoutIcon } from '@heroicons/react/solid';
import http from '@/api/http';
import ThemeSelector from '@/skyactyl/ui/ThemeEngine';
import SpinnerOverlay from '@/components/elements/SpinnerOverlay';
import { useTranslation } from 'react-i18next';
import LanguageSwitcher from '@/skyactyl/ui/LanguageSwitcher';
import { InvertToggle } from '@/skyactyl/ui/SmartInvert';
...
export default () => {
    ...
    const themeSelector = useStoreState((state) => state.skyactyl.data!.themeSelector);
